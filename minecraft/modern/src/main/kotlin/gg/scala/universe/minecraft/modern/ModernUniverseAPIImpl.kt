...
class ModernUniverseAPIImpl(
    ...
    private val _instanceManager = ModernInstanceManager()
    private val _configurationManager = ModernConfigurationManager()
    private val _templateManager = ModernTemplateManager()
    ...
    inner class ModernInstanceManager : InstanceManager {
    ...
    inner class ModernConfigurationManager : ConfigurationManager {
    ...
    inner class ModernTemplateManager : TemplateManager {
