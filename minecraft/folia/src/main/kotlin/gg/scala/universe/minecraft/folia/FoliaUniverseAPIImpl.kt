...
class FoliaUniverseAPIImpl(
    ...
    private val _instanceManager = FoliaInstanceManager()
    private val _configurationManager = FoliaConfigurationManager()
    private val _templateManager = FoliaTemplateManager()
    ...
    inner class FoliaInstanceManager : InstanceManager {
        ...
        override fun reportState(state: InstanceState): CompletableFuture<Void> {
            return CompletableFuture.runAsync {
                if (this@FoliaUniverseAPIImpl.instanceId == null) return@runAsync
                val url = "$masterUrl/api/instances/${this@FoliaUniverseAPIImpl.instanceId}/state"
    ...
    inner class FoliaConfigurationManager : ConfigurationManager {
    ...
    inner class FoliaTemplateManager : TemplateManager {
