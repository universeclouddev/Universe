...
class BungeeUniverseAPIImpl(
    ...
    private val _instanceManager = BungeeInstanceManager()
    private val _configurationManager = BungeeConfigurationManager()
    private val _templateManager = BungeeTemplateManager()
    ...
    inner class BungeeInstanceManager : InstanceManager {
        ...
        override fun reportState(state: InstanceState): CompletableFuture<Void> {
            return CompletableFuture.runAsync {
                if (this@BungeeUniverseAPIImpl.instanceId == null) return@runAsync
                val url = "$masterUrl/api/instances/${this@BungeeUniverseAPIImpl.instanceId}/state"
    ...
    inner class BungeeConfigurationManager : ConfigurationManager {
    ...
    inner class BungeeTemplateManager : TemplateManager {
